    ...
    impl PowerReleaseRepr {
        fn release_message(self) -> String {
            String::from(match self {
                Self::P1 => "P1 instruction introduced in POWER Architecture",
                Self::P2 => "P2 Instruction introduced in POWER2 Architecture",
                Self::PPC => "PPC Instruction introduced in PowerPC Architecture prior to v2.00",
                Self::v200 => "v2.00 Instruction introduced in PowerPC Architecture Version 2.00",
                Self::v201 => "v2.01 Instruction introduced in PowerPC Architecture Version 2.01",
                Self::v202 => "v2.02 Instruction introduced in PowerPC Architecture Version 2.02",
                Self::v203 => "v2.03 Instruction introduced in Power ISA Version 2.03",
                Self::v204 => "v2.04 Instruction introduced in Power ISA Version 2.04",
                Self::v205 => "v2.05 Instruction introduced in Power ISA Version 2.05",
                Self::v206 => "v2.06 Instruction introduced in Power ISA Version 2.06",
                Self::v207 => "v2.07 Instruction introduced in Power ISA Version 2.07",
                Self::v30 => "v3.0 Instruction introduced in Power ISA Version 3.0",
                Self::v30B => "v3.0B Instruction introduced in Power ISA Version 3.0B",
                Self::v30C => "v3.0C Instruction introduced in Power ISA Version 3.0C",
                Self::v31 => "v3.1 Instruction introduced in Power ISA Version 3.1",
                Self::v31B => "v3.1B Instruction introduced in Power ISA Version 3.1B",
            })
        }
    }
    #[allow(dead_code)]
